// Add this function to fetch the weekly forecast
void weather_fetch_weekly_forecast(void) {
    ...
    if (status_code == 200) {
        int total_len = esp_http_client_read(client, buffer, 2048);
        // Parse the JSON response to extract forecast data
        // Use cJSON or similar library to parse the JSON
