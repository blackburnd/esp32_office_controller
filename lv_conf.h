...
#define LV_TICK_CUSTOM 0
    ...
    /*If using lvgl as ESP component*/
 ...
 *LV_DITHER_GRADIENT implies LV_DITHER_ERROR_DIFFUSION=1 error diffusion dithering gets applied where gradients are drawn*/
#define LV_DITHER_GRADIENT 0
#if LV_DITHER_GRADIENT
    /*Add support for error diffusion dithering.
     *Error diffusion dithering gets applied when gradients are drawn.
     *This ensures that the color output is - in total - as close in color as possible to the colors specified in the gradient*/
...
#define LV_USE_GPU_GD32_IPA 0
    ...
    /*Must be defined to include path of CMSIS header of target processor
    e.g. "gd32f40x.h"*/
    #define LV_GPU_GD32_IPA_CMSIS_INCLUDE
#endif
 ...
 *If LV_USE_ASSERT is enabled an error message will be printed on failure*/
#define LV_USE_ASSERT 1
    ...
    /*Check if the strings are NULL, not empty or not too long. (Quite slow)*/
    ...
    /*Check if the memory initialization and deinitialization is correct. (Fast)*/
 ...
 *should also appear on LVGL binding API such as Micropython or others.*/
